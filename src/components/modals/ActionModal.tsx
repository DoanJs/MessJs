...
import { CloseCircle, Profile2User, UserAdd, UserRemove } from 'iconsax-react-native';
    ...
    >
      <View style={styles.modalBox}>
        ...
        <RowComponent>
          ...
          <TextComponent text="Gửi lời mời kết bạn" />
        </RowComponent>
        <SpaceComponent height={16} />
        <RowComponent>
          <UserRemove
          ...
          />
          <SpaceComponent width={16} />
          <TextComponent text="Hủy kết bạn" />
        </RowComponent>
        <SpaceComponent height={16} />
        <RowComponent>
          <CloseCircle
